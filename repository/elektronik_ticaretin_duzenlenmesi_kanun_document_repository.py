...
class ElektronikTicaretinDuzenlenmesiKanunDocumentRepository(DocumentRepositoryBase):
    def __init__(
            self,
            file_path: str
    ):
        ...
        self._logger.info(f"Initializing elektronik_ticaretin_duzenlenmesi_kanun Document Repository")
