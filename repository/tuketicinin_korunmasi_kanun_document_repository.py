...
class TuketicininKorunmasiKanunDocumentRepository(DocumentRepositoryBase):
    def __init__(
            self,
            file_path: str
    ):
        ...
        self._logger.info(f"Initializing tuketicinin_korunmasi_kanun Document Repository")
